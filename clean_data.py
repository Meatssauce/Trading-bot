...
"""
Idea:
Take a five year period of QRs as input and output buy, sell or hold for next quarter
...
- takes relative change as input with the addition of relative total assets (not the change thereof)
